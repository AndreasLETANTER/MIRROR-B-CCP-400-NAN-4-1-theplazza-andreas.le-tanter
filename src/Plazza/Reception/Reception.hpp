    ...
    */
    class Reception : public IReception {
        ...
        protected:
        private:
            typedef boost::interprocess::allocator<std::unique_ptr<IKitchen>, boost::interprocess::managed_shared_memory::segment_manager> m_ShmemAllocator;
            typedef boost::interprocess::vector<std::unique_ptr<IKitchen>, m_ShmemAllocator> m_SharedVector;
